...
function mega_scripts() {
	...
	wp_enqueue_style( 'mega-slider', $get_template_directory_uri.'/public/libs/swiper/css/swiper.min.css' );
	// wp_enqueue_style( 'mega-range-slider', $get_template_directory_uri.'/public/libs/ion-rangeslider/css/ion.rangeSlider.min.css' );
...
function wpb_custom_new_menu() {
  register_nav_menu('menu-aside',__( 'Боковое Меню ' ));
